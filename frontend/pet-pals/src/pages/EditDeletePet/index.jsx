    ...
    const fetchData = async () => {
      try {
        ...
        const requestOptions = {
          ...
          headers: {
            Authorization:
              "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzAxNzkzOTA1LCJpYXQiOjE3MDE3MDc1MDUsImp0aSI6IjQzMThhMjFhNGJiOTRjZjhhMmZlMTA5ZDVkNTBmMTk4IiwidXNlcl9pZCI6MTF9.PEsDrK3_I6m7in-NLVg3jYO8abTRHlf6AuxbArEA8dk",
          },
        };
