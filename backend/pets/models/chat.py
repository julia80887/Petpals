...
class Chat(models.Model):
    ...
    seeker = models.ForeignKey(Seeker, on_delete=models.CASCADE,
                               related_name='application_chats')  # Foreign Key to Seeker
    shelter = models.ForeignKey(
        Shelter, on_delete=models.CASCADE, related_name='application_chats')
    application = models.ForeignKey(
        Application, on_delete=models.CASCADE, related_name='application_chats')
